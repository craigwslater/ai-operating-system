...
> **Why it's included.** Backs the composer/verifier pattern cited throughout the portfolio's case-study tier (CS#2 in particular) and the "40 evals, ~42 detectors, hundreds of errors caught and fixed autonomously per month" quantitative spine: every workflow step, every detector reference, every encode-into-source rule lives in this file alongside CS#2.
