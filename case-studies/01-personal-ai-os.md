...
**Versioned project releases.** The job-materials skill has shipped 46 evals. The claude-local-frontier meta-project shipped seven structural improvements across two versions. Each release closes with a retrospective and a commitment-verification audit. The discipline produces visible cadence.
