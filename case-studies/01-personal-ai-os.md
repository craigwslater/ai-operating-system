...
`~/aios/policies/` holds fourteen documented workflows. Nine port to the redacted artifact tier: [`session-start.md`](../artifacts/policies/session-start.md), [`session-end.md`](../artifacts/policies/session-end.md), [`new-project-intake.md`](../artifacts/policies/new-project-intake.md), [`commitment-verification-audit.md`](../artifacts/policies/commitment-verification-audit.md), [`file-delivery.md`](../artifacts/policies/file-delivery.md), [`skill-roadmap.md`](../artifacts/policies/skill-roadmap.md), [`publish-portfolio.md`](../artifacts/policies/publish-portfolio.md), [`memory-architecture.md`](../artifacts/policies/memory-architecture.md), and [`escalation.md`](../artifacts/policies/escalation.md). The remaining five—`autonomy-eligibility.md`, `memory-detector-parameters.md`, `pre-write-verification.md`, `sync-private-mirror.md`, and `visual-communication.md`—stay source-side. Not all are step-sequenced: several are reference specs read from inside another workflow rather than run on their own. Each is either exposed as a slash command—`/start-session`, `/end-session`, `/start-project`, `/audit`, `/promote-canonical`, among twenty-five now installed—or invoked from inside one, so the workflow runs the same way every time.
